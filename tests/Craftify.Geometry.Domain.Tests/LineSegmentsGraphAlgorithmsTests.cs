...
public class LineSegmentsGraphAlgorithmsTests
{
    ...
    static LineSegmentsGraph _graph => new(ReadOnlyList.Of(
        [
    ...
    {
        var actualPath = graph.Dijkstra(start, end).ToList();
        ...
        else
        {
            actualPath
                ...
                .AllSatisfy(edge =>
                {
                    int index = actualPath.IndexOf(edge);
